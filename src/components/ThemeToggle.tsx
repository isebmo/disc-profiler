...
export default function ThemeToggle() {
  ...
  return (
    <button
      onClick={toggle}
      className="fixed top-4 right-4 z-50 w-10 h-10 flex items-center justify-center rounded-full bg-white/80 dark:bg-[#303134]/80 backdrop-blur border border-[#DADCE0] dark:border-[#5F6368] hover:bg-[#F1F3F4] dark:hover:bg-[#3C4043] transition-colors"
